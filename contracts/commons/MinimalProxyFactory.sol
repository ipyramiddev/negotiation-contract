...
contract MinimalProxyFactory {
     ...
     */
    function _createProxy(bytes32 _salt, bytes memory _data)
        internal
        virtual
                    ...
                    uint256(
                        keccak256(
                            abi.encodePacked(
                                ...
                                address(this),
                                keccak256(
                                    abi.encodePacked(_salt, _address, _data)
                                ),
                                codeHash
                            )
                        )
    ...
    function _setImplementation(address _implementation) internal {
        require(
            ...
            "MinimalProxyFactory#_setImplementation: INVALID_IMPLEMENTATION"
        );
