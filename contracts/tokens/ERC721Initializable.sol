...
// OpenZeppelin Contracts v4.4.1 (token/ERC721/ERC721Initializable.sol)
 ...
 * {ERC721Enumerable}.
 */
contract ERC721Initializable is ContextMixin, ERC165, IERC721, IERC721Metadata {
    ...
    function _transfer(
        ...
        require(
            ERC721Initializable.ownerOf(tokenId) == from,
