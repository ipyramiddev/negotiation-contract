...
import type {
  ...
  ERC721BaseCollectionInterface,
} from "../ERC721BaseCollection";
...
export class ERC721BaseCollection__factory {
  static readonly abi = _abi;
  static createInterface(): ERC721BaseCollectionInterface {
    return new utils.Interface(_abi) as ERC721BaseCollectionInterface;
  }
  static connect(
    address: string,
