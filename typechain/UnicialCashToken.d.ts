...
interface UnicialCashTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class UnicialCashToken extends BaseContract {
  ...
  interface: UnicialCashTokenInterface;
