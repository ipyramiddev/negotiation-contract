...
interface ERC721CollectionFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721CollectionFactory extends BaseContract {
  ...
  interface: ERC721CollectionFactoryInterface;
